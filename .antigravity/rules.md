...
These rules are synced from `rules/core.md` and `rules/workflow.md`.

## Core
- Follow `INSTRUCTIONS.md`.
- Use the appropriate agent and state which agent/skills are active.
- Do not assume stack/commands; read files first.
- Ask questions if unclear; wait for answers.
- Avoid destructive commands unless explicitly requested.

## Workflow
1. Read `INSTRUCTIONS.md` and the relevant agent file.
2. Read `.claude/guides/`.
