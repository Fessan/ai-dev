...
Создание ПРД/плана/задач выполняется до апрува, апрув нужен перед реализацией.
...
Если пользователь уже принёс PRD в корень проекта (Markdown), не редактируй исходник:
- Считай его Source PRD
- Создай нормализованный PRD в `work/YYYY-MM-DD--feature-name/prd.md`
...
### 8. Обнови guides (АВТОМАТИЧЕСКИ)

После создания ПРД и плана автоматически обнови guides без запроса апрува:

**Обнови `.claude/guides/features.md`:**
- Добавь фичу в раздел "В разработке"
- Укажи название, описание, статус "В планировании"
- Добавь ссылку на ПРД

**Обнови `docs/plans.md`:**
- Добавь строку в таблицу "Активные фичи"
- Укажи название, ссылки на ПРД и план, статус, дату начала

Пример добавления в features.md:
```markdown
## В разработке

### Авторизация пользователей
- **Описание**: Система входа через email и пароль с JWT токенами
- **Статус**: В планировании
- **ПРД**: work/2025-01-15--user-auth/prd.md
```
