...
**Точка входа** для Claude Code, Codex CLI и других ИИ-инструментов (вместе с `AGENTS.md`).

## Rules Sync

Источник истины для общих правил: `rules/core.md` и `rules/workflow.md`.
Эти правила должны быть синхронизированы в `AGENTS.md`, `CLAUDE.md`,
`.cursorrules` и `.antigravity/rules.md`.
Любые изменения в `rules/` требуют синхронизации всех целевых файлов.
...
- [ ] **PRD** для фичи создан/обновлён в `work/YYYY-MM-DD--feature/prd.md`, а `docs/plans.md` обновлён ссылкой (если PRD нет — сначала вопросы и стоп)
...
После завершения задачи переноси её в `work/_archive/` и оставляй в активной папке только текущие задачи.
...
**Если PRD уже есть в корне проекта (Markdown):**
- Не редактируй исходный файл
- Создай нормализованный PRD в `work/YYYY-MM-DD--feature/prd.md`
- Добавь ссылку на Source PRD в рабочий PRD и в `docs/plans.md`
...
**После завершения работы `code-developer` всегда запускай `code-reviewer`.**
